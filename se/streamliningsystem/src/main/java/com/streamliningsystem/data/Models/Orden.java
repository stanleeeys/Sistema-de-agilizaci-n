...
public class Orden {
    ...
    private Date limite_cotizacion;
    
    private Date fecha_de_entrega;
    
    private String hora_entrega_desde;
    
    private String hora_entrega_hasta;
    ...
    private String vigencia_de_la_cotizacion; 
    
    private String tiempo_de_garantia;
